...
@never_cache
def dashboard(request, issue=None):
    """
...
@login_required
@never_cache
def preview_home_article(request, article_id):
    """
    Displays a preview of an homepage's article.
    
    """
    context = {}
    return render_to_response(
        'custom_admin/preview/home_article.html',
        context,
        context_instance=RequestContext(request)
    )
...
@login_required
@never_cache
def preview_home_note(request, note_id):
    """
    Displays a preview of an homepage's note.
    
    """
    context = {}
    return render_to_response(
        'custom_admin/preview/home_note.html',
        context,
        context_instance=RequestContext(request)
    )
...
@login_required
@never_cache    
def preview_category_article(request, category_slug, article_id):
    """
    Displays a preview of a category's article.
    
    """
    context = {}
    return render_to_response(
        'custom_admin/preview/category_article.html',
        context,
        context_instance=RequestContext(request)
    )
...
@login_required
@never_cache
def preview_category_note(request, category_slug, note_id):
    """
    Displays a preview of a category's note.
    
    """
    context = {}
    return render_to_response(
        'custom_admin/preview/category_note.html',
        context,
        context_instance=RequestContext(request)
    )
...
@login_required
@never_cache    
def preview_category_voyages_article(request, article_id):
    """
    Displays a preview of a 'Voyages' category article.
    
    """
    context = {}
    return render_to_response(
        'custom_admin/preview/category_voyages_article.html',
        context,
        context_instance=RequestContext(request)
    )
...
@login_required
@never_cache    
def preview_category_epicurien_article(request, article_id):
    """
    Displays a preview of an 'Epicurien' category article.
    
    """
    context = {}
    return render_to_response(
        'custom_admin/preview/category_epicurien_article.html',
        context,
        context_instance=RequestContext(request)
    )
...
@login_required
@never_cache    
def preview_category_anger_article(request, article_id):
    """
    Displays a preview of an 'Anger' category article.
    
    """
    context = {}
    return render_to_response(
        'custom_admin/preview/category_anger_article.html',
        context,
        context_instance=RequestContext(request)
    )
