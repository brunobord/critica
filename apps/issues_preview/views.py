...
def preview_home(request, issue_key):
    """
...
def preview_category(request, issue_key, category_slug):
    """
...
def preview_category_regions(request, issue_key):
    """
...
def preview_category_voyages(request, issue_key):
    """
...
def preview_category_epicurien(request, issue_key):
    """
...
def preview_category_anger(request, issue_key):
    """
